...
{{% button href="https://raw.githubusercontent.com/SMAC-Group/ptds/master/data/class_sa.Rmd" icon="fa fa-fw fa-download" %}}Get R file from Lecture #8 on Shiny App{{% /button %}}
